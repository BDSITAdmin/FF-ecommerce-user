  ...
  return (
    <div className="font-figtree">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-2 py-25">
        ...
        <div className="px-10">
          <div className="">
            <h1 className="text-[64px] font-bold mb-4">{product.name}</h1>
        ...
        <div className="bg-[#0e6ea8] pl-14 py-14 pr-10 rounded-2xl  ">
          ...
          <div className="max-w-304 space-y-10">
            ...
            <div className="bg-[#FFFFFF] rounded-xl px-16 py-20 grid grid-cols-1 lg:grid-cols-2 gap-6 items-center">
              <div>
                <h2 className="font-bold leading-[-1%]  text-[28px] mb-3">What is {product.name}?</h2>
                <p className="text-md font-normal text-[#181818] leading-5.5">
                  ixan+ is a patented, clinically validated antioxidant and anti-inflammatory formulation created to safeguard eyes from the constant stress of modern living.<br></br><br></br>
                  Daily exposure to digital screens, pollution, irregular meals, and chronic stress accelerates oxidative damage impacting the eyes first, as they are among the most sensitive organs in the body.<br></br>
                  ixan+ brings together a powerful blend of Curcuminoids, Lutein, Zeaxanthin, Bilberry, Licorice, Alpha Lipoic Acid, and Zinc to form a synergistic matrix that works at multiple levels:<br></br>
                  Supports ocular protection and strengthens retinal cells<br></br>
                  Helps maintain visual performance under digital and environmental strain<br></br>
                  Promotes metabolic balance, relevant for individuals at risk of or experiencing diabetic eye changes<br></br><br></br>
            ...
            <div className="bg-[#FFFFFF] rounded-xl px-16 py-20 grid grid-cols-1  gap-6 items-center">
              <h2 className="font-bold leading-9 tracking-[-1%]   text-[28px] mb-3">What Makes {product.name} Different?</h2>
              ...
              <div className="grid grid-cols-3 gap-6 text-sm">
                <div>
                  ...
                  <h3 className="font-bold text-[16px] leading-6 mb-1">1. Synergistic Antioxidant & Anti-inflammatory Matrix (Patented)</h3>
                ...
                <div>
                  ...
                  <h3 className="font-bold text-[16px] leading-6 mb-1">2. Retina-Targeted Protection</h3>
                  <p className="text-[#181818] leading-6 text-[16px]">

                    Ingredients like Bilberry, ALA, and Zinc provide micro-vascular support
                    essential for retinal health especially in conditions like Diabetic Retinopathy.
                  </p>
                </div>

                <div>
                  <img src="/icons/nuclie-icon.svg" alt="Nuclie" className="mb-2 h-12 w-12" />
                  <h3 className="font-bold text-[16px] leading-6 mb-1">3. Cellular + Organ Wellness</h3>
                  <p className="text-[#181818] leading-6 text-[16px]">

                    ixan+ isn’t just an eye supplement-it protects cells,
                    tissues, and metabolic pathways impacted by oxidative stress.
                  </p>
                </div>
                <div>
                  <img src="/icons/research-icon.svg" alt="Research" className="mb-2 h-12 w-12" />
                  <h3 className="font-bold text-[16px] leading-6 mb-1"> 4. Clinically Referenced Formulation</h3>
                  <p className="text-[#181818] leading-6 text-[16px]">
                ...
                <div>
                  ...
                  <h3 className="font-bold text-[16px] leading-6 mb-1">5. Clean Label & Daily-Use Friendly</h3>
                  <p className="text-[#181818] leading-6 text-[16px]">
            ...
            <div className="bg-[#FFFFFF] rounded-xl p-16 grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className=" grid grid-cols-1 gap-4">
                <div>
                  <h2 className="font-bold leading-[-1%]  text-[28px] mb-3">Why This Combination Works</h2>
                  <p className="font-normal text-[16px] leading-6 tracking-normal mb-4">
                    Each ingredient is powerful alone, but in ixan+ they form a synergistic antioxidant & anti-inflammatory matrix that protects:
                  </p>
                  <p className="font-normal text-[16px] leading-6 tracking-normal mb-4">
                    Vision clarity<br></br>
                    Retinal microvascular health<br></br>
                    Macular pigment density<br></br>
                    Cellular and metabolic balance<br></br>
                    Eyes at risk of diabetic complications
                  </p>
                </div>
                <div>
                  <h2 className="font-bold leading-[-1%]  text-[28px] mb-3">Who Should Use ixan+?</h2>

                  <p className="font-normal text-[16px] leading-6 tracking-normal mb-4">
                    Individuals with high screen time<br></br>
                    Those experiencing eye strain, dryness, or irritation<br></br>
                    Adults wanting macular & retinal protection<br></br>
                    Individuals with early signs of retinal stress<br></br>
                    People living with or at risk of Diabetic Retinopathy<br></br>
                    Anyone seeking a daily antioxidant + eye health supplement
                  </p>
                </div>
                <div>
                  <h2 className="font-bold leading-[-1%]  text-[28px] mb-3">How to Use</h2>
                  <p className="font-normal text-[16px] leading-6 tracking-normal mb-4">
                    1 capsule once a day as maintenance dose,<br></br>
                  ...
                  <p className="font-normal text-[16px] leading-6 tracking-normal mb-4">
                    Science-Driven. Nature-Powered.<br></br>
            ...
            <div className=" rounded-xl mb-6">
              <h2 className="font-bold leading-[-1%]  text-[28px] text-[#FFFFFF] mb-6">Client Testimonials</h2>
              <div className=" grid grid-cols-1 md:grid-cols-2 gap-6">
                {testimonials.map((testimonial, index) => (
                  <div key={index} className="bg-[#023954] text-[#FFFFFF] rounded-xl px-9 py-12">
                    <p className="font-normal text-[20px] leading-7 tracking-normal mb-1">{testimonial.title}</p>
