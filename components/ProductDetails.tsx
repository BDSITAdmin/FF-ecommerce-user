        ...
        <div className=" mt-4 pb-4 sm:mt-12 px-4 sm:px-0 lg:px-8 ">
          ...
          <div className=" sm:mt-14 mb-4">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:mt-16 ">
              ...
              <button
                onClick={handleAddToCart}
                className="w-full sm:w-auto px-5 py-4 sm:px-24 sm:py-5   sm:text-[20px] leading-5 tracking-normal rounded-full bg-[#0065A6] text-white font-medium hover:opacity-90 transition"
              >
                Add to Cart
              </button>
